...
*
       ...
       INTEGER NF
*
c       P2GGB = ( 2643.521 - NF * 412.172 - NF**2 * 16./9.D0 ) / ( 1.-Y) 
c       My modification 
       P2GGB = ( 2643.521 - NF * 412.172 - NF**2 * 16./9.D0 )
*
       RETURN
       END
*
...
*
       DL1 = LOG (1.-Y)
*
c       P2GGC =       2643.521 * DL1 + 4425.448 + 0.446
c     ,       - NF * ( 412.172 * DL1 +  528.720 + 0.003 )
c     ,       + NF**2 * ( - 16./9.D0 * DL1 + 6.4630)
c     My modification
       P2GGC =        4425.448 + 0.446
     ,       - NF * ( 528.720 + 0.003 )
     ,       + NF**2 * ( 6.4630)
*
       RETURN
