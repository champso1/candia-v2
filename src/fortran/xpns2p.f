...
*
       ...
       INTEGER NF
*
c       P2NSB = ( 1174.898 - NF * 183.187 - NF**2 * 64./81.D0 ) / (1.-Y)
c       My modification
       P2NSB = ( 1174.898 - NF * 183.187 - NF**2 * 64./81.D0 )
*
       RETURN
       END
*
...
*
       DL1 = LOG (1.-Y)
*
c       P2NSPC =       1174.898 * DL1 + 1295.624 - 0.24
c     ,        - NF * ( 183.187 * DL1 + 173.938 - 0.011 )
c     ,        + NF**2 * ( - 64./81.D0 * DL1 + 1.13067 )
c       My modification
       P2NSPC =       1295.624 - 0.24
     ,        - NF * ( 173.938 - 0.011 )
     ,        + NF**2 * ( 1.13067 )
*
       RETURN
...
*
       DL1 = LOG (1.-Y)
*
c       P2NSMC =       1174.898 * DL1 + 1295.624 - 0.154
c     ,        - NF * ( 183.187 * DL1 + 173.938  - 0.005 )
c     ,        + NF**2 * ( - 64./81.D0 * DL1 + 1.13067 )
c     My modification
       P2NSMC =       1295.624 - 0.154
     ,        - NF * ( 173.938  - 0.005 )
     ,        + NF**2 * ( 1.13067 )
*
       RETURN
