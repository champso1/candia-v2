CC ADPGhplog version 1.0.  NUMERICAL EVALUATION OF HARMONIC POLYLOGARITHMS.  
C    T. GEHRMANN, E. REMIDDI.                                                  
CC REF. IN COMP. PHYS. COMMUN. 141 (2001) 296                                  
******************************************************************************
...
*         v = log(1.d0+y) 
     ...
     $              +e2*(1.d0/19+e2*(1.d0/21+e2*(1.d0/25+e2*(1.d0/27    
     $              )))))))))))))
         HY1(-1) = v 
      endif 
      if (y.ge.0d0) then 
